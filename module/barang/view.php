            ...
            <div class="main-content">
                            ...
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <button class="au-btn au-btn-icon au-btn--blue">
                                        <a href="?pages=add_barang"><font color="blue">Tambah Jenis Barang</font></a></button>
                                </div>
              ...
              <table class="table table-hover">
               ...
               <?php
				$sql = "SELECT * FROM barang ORDER BY kodebarang ASC";
				$data = $conn->prepare($sql);
				$data->execute();
			
				while($row = $data->fetch(PDO::FETCH_OBJ)){
					$link_del = "index.php?pages=barang&act=delete&ID=$row->kodebarang";
						$link_edit = "index.php?pages=add_barang&act=edit&ID=$row->kodebarang";
				...
				if(isset($_GET["act"])=="delete"):
					try {
						$sql = "DELETE FROM barang WHERE kodebarang='".$_GET["ID"]."'";
						  if ($conn->query($sql)) 
						  {
