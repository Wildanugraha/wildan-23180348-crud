 ...
 <?php
 	if(isset($_GET['act'])=="edit"){
 		$stmt = $conn->prepare("SELECT * FROM minuman WHERE kodebarang='".$_GET["ID"]."'");
		$stmt->execute();
 ...
 ?>
	...
	<?php
	  if(isset($_POST["btnSimpan"])):
		...
		try {
			if(isset($_GET['act'])=="edit")
				$sql = "UPDATE minuman SET kodebarang='$a', namabarang='$b',stok='$d',hargajual='$e' WHERE kodebarang='".$_GET["ID"]."'";				
			else
				$sql = "INSERT INTO minuman (kodebarang,namabarang,stok,hargajual) VALUES ('$a','$b','$d','$e')";
